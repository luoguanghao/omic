...
samtools sort -@ 8 ${sample}/${sample}.bam -o ${sample}/${sample}_sorted.bam 1> ${sample}/${sample}_log.samtools_sort 2>&1
samtools index -@ 8 ${sample}/${sample}_sorted.bam ${sample}/${sample}_sorted.bai 1> ${sample}/${sample}_log.samtools_index 2>&1
