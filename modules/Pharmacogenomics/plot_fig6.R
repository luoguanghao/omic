...
# 
# 
jn_plot6_boxplot <- function(drug,gene,ylab,exp_mat,drug_sen_df){
    ...
    df_fpr_plot = data.frame(sample=colnames(exp_mat),exp=t(exp_mat)[,gene],drug_sen=rep('NA',dim(exp_mat)[2]))
