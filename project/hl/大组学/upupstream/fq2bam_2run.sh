...
echo ''
echo 'action! bwa ...'
bwa mem -t 8 -R '@RG\tID:$sample\tSM:$sample\tLB:WES\tPL:Illumina' \
${idx} \
${fq1_1} \
${fq1_2} \
> ${sample}/${sample}_1.sam 2> ${sample}/${sample}_1.bwa.log

samtools view -S ${sample}/${sample}_1.sam -b -o ./${sample}/${sample}_1.bam
...
${fq2_1} \
${fq2_2} \
> ${sample}/${sample}_2.sam 2> ${sample}/${sample}_2.bwa.log

samtools view -S ${sample}/${sample}_2.sam -b -o ./${sample}/${sample}_2.bam



echo 'merge bam ......'

samtools merge ${sample}.bam ${sample}_1.bam ${sample}_2.bam
